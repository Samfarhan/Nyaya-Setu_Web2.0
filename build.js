...
const orgSchema = {
    ...
    "sameAs": [
        ...
        "https://instagram.com/harsh.exe._"
    ],
    "founder": [
        {
            "@type": "Person",
...
<head>
    ...
    <link rel="stylesheet" href="${relPrefix}css/styles.css?v=12.0">
    <style id="nyayi-cursor-style">
        @media (min-width: 992px) {
            ...
            .cursor-dot {
                ...
                background-color: var(--primary, #00C853) !important;
            }
            .cursor-outline {
                width: 40px !important;
                height: 40px !important;
                border: 1px solid var(--primary, #00C853) !important;
            ...
            <div class="creators-grid">
                <div class="creator-profile" data-aos="fade-up">
                    ...
                    <div class="cp-actions">
                        ...
                        <a href="tel:9598042676" class="cp-btn secondary"><i class="fas fa-phone-alt"></i> Call</a>
                    </div>
                </div>
                
                <div class="creator-profile" data-aos="fade-up" data-aos-delay="100">
                    <div class="cp-icon"><i class="fas fa-scale-balanced"></i></div>
                    <h3>Kamran Sheikh</h3>
                    <span class="cp-role">CEO & Legal Researcher</span>
                    <div class="cp-actions">
                        <a href="https://instagram.com/kamran.irll" target="_blank" class="cp-btn"><i class="fab fa-instagram"></i> View Profile</a>
                        <a href="tel:7393905299" class="cp-btn secondary"><i class="fas fa-phone-alt"></i> Call</a>
                    </div>
                </div>

                <div class="creator-profile" data-aos="fade-up" data-aos-delay="200">
                    <div class="cp-icon"><i class="fas fa-palette"></i></div>
                    <h3>Harsh Rawat</h3>
                    <span class="cp-role">Co-Founder & UI/UX Designer</span>
                    <div class="cp-actions">
                        <a href="https://instagram.com/harsh.exe._" target="_blank" class="cp-btn"><i class="fab fa-instagram"></i> View Profile</a>
                        <a href="tel:8470879970" class="cp-btn secondary"><i class="fas fa-phone-alt"></i> Call</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        if (cursorDot && cursorOutline) {
            ...
            if (isMobile) {
                ...
                const dyn = document.getElementById('nyayi-dynamic-cursor-css');
                if (dyn) dyn.remove();
            } else {
                document.documentElement.classList.add('custom-cursor-enabled');
                if (!document.getElementById('nyayi-dynamic-cursor-css')) {
                    const dynStyle = document.createElement('style');
                    dynStyle.id = 'nyayi-dynamic-cursor-css';
                    dynStyle.textContent = '*, *::before, *::after, html, body, a, button, input, select, textarea, label, [role="button"], .btn, .btn-primary, .btn-outline, .hero-btns a, .term-pill, .cp-btn, .filter-btn, .search-box input { cursor: none !important; }';
